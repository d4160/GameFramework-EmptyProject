...
namespace Chronos.ReorderableList.Internal {
	...
	public static class ReorderableListResources {
		...
		/// <summary>
		/// Resource scenes for light skin.
		/// </summary>
		/// <remarks>
		/// <para>Resource scenes are PNG images which have been encoded using a base-64
		/// string so that actual scenes files are not necessary.</para>
		/// </remarks>
		...
		/// <summary>
		/// Read textures from base-64 encoded strings. Automatically selects scenes based
