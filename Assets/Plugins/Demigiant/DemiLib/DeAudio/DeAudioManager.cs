...
namespace DG.DeAudio
{
    ...
    public class DeAudioManager : MonoBehaviour
    {
        ...
        public static DeAudioGroup[] audioGroups; // Internal so Inspector can read it
        public static DeAudioGroup globalGroup; // Group created when playing a clip without any group indication. Also stored as the final _audioGroups value
