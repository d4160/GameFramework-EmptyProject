...
namespace Fungus.EditorUtils
{
    ...
    [UnityEditor.Experimental.AssetImporters.ScriptedImporter(1, "lua")]
    public class LuaScriptedImporter : UnityEditor.Experimental.AssetImporters.ScriptedImporter
    {
