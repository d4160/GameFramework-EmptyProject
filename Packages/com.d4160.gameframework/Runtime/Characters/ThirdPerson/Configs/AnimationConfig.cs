...
namespace StandardAssets.Characters.ThirdPerson.Configs
{
	...
	public class AnimationConfig : ScriptableObject
	{
		...
		class AdvancedAnimationConfig
		{
			...
			/// </summary>
			public Vector2 turningSpeedInterpolationRange { get { return m_TurningSpeedRange; } }

			/// <summary>
			/// Gets the range used to interpolate the animator's lateral speed. This range will return a damp time that
			/// is passed on to the animator in <see cref="Animator.SetFloat(string, float, float, float)"/>.
			/// </summary>
			public Vector2 lateralSpeedInterpolationRange { get { return m_LateralSpeedRange; } }

			/// <summary>
			/// Gets the range used to interpolate the animator's forward speed. This range will return a damp time that
			/// is passed on to the animator in <see cref="Animator.SetFloat(string, float, float, float)"/>.
			/// </summary>
			public Vector2 forwardSpeedInterpolationRange { get { return m_ForwardSpeedRange; } }
		}
		...
		/// </summary>
		public Vector2 forwardSpeedInterpolation { get { return m_Advanced.forwardSpeedInterpolationRange; } }

		/// <summary>
		/// Gets the lateral speed parameter configuration.
		/// </summary>
		public Vector2 lateralSpeedInterpolation { get { return m_Advanced.lateralSpeedInterpolationRange; } }

		/// <summary>
		/// Gets the turning speed parameter configuration.
		/// </summary>
		public Vector2 turningSpeedInterpolation { get { return m_Advanced.turningSpeedInterpolationRange; } }
